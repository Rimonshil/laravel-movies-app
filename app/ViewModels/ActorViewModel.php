...
class ActorViewModel extends ViewModel
{
    ...
    public function __construct($popularActor, $social, $credits)
    {
    ...
    {
        return collect($this->popularActor)->merge([
            'birthday' => Carbon::parse($this->popularActor['birthday'])->format('M d, Y'),
            'age' =>  Carbon::parse($this->popularActor['birthday'])->age,
            'profile_path' => $this->popularActor['profile_path']
            ? 'https://image.tmdb.org/t/p/w300/'.$this->popularActor['profile_path']
