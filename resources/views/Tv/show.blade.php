...
<div class="tvshow-info border-b border-gray-900">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row lg:flex-row">
        <img src="{{ 'https://image.tmdb.org/t/p/w400/'.$tvshow['poster_path']}}" alt="parasite" class="w-64 lg:w-64">
        <div class="ml-24">
            ...
            <div class="flex items-center text-gray-400 text-sm">
                ...
                <span class="ml-2">{{ \Carbon\Carbon::parse($tvshow['first_air_date'])->format('M d, Y') }}</span>
                <span class="ml-2"> | </span>
                <span class="ml-2">
           ...
           @endforeach
            ...
            <div class="mt-12">
             ...
             <div class="mt-12">
                <button href="https://youtube.com/watch?v={{$tvshow['videos']['results'][0]['key']}}" class="flex inline-flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150" @click="isOpen=true">
                    ...
                    <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                        <div class="bg-gray-900 rounded">
                            <div class="flex justify-end pr-4 pt-2">
                                <button
                                    class="text-3xl leading-none hover:text-gray-300" @click="isOpen=false"  @keydown.escape.window="isOpen = false">&times;
                                </button>
                            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            @if ($loop->index < 5)
                ...
                <a href="{{route('actors.show', $cast['id'])}}">
                        <img src="{{ 'https://image.tmdb.org/t/p/w300/'.$cast['profile_path']}}" alt="profile" class="hover:opacity-75 transition ease-in-out duration-1">
                    </a>
                    <div class="mt-2">
                    <a href="#" class="mt-2 text-lg hover:text-gray-300">{{$tvshow['name']}}</a>
                        <div class="flex items-center text-gray-400 text-md mt-1">
                        <span >{{$cast['name']}}</span>                     
                        </div>
